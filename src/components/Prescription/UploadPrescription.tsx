...
export function UploadPrescription({ setFilters }: UploadPrescriptionProps) {
  ...
  const handleUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setTimeout(() => {
      ...
      // Apply prescription-based filters (simulated)
      setFilters((prev: any) => ({
        ...prev,
        skinType: ["Sensitive"],
      ...
      toast.success("Prescription analyzed", {
        description: "We've applied filters based on your prescription"
      });
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl p-4 shadow-sm">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h3 className="text-sm font-medium">Have a Prescription?</h3>
      </div>
      
      <p className="text-xs text-muted-foreground mb-3">
        Upload your dermatologist's prescription for personalized product suggestions
      </p>
